## Java and Kubernetes | [Digital Innovation One](https://digitalinnovation.one/)
...
## 💻 Technologies
    ...
    - Minikube (simulation of a local cluster - mono cluster)
    - Kubectl (command line to interact with the cluster)
    - Mysql
---
...
```bash
git clone https://github.com/antoniosergiojr/java_kubernetes_digital_innovation_one.git 
or git clone https://github.com/sandrogiacom/java-kubernetes.git
```

**Build application**
```bash
cd java_kubernetes_digital_innovation_one 
or cd java-kubernetes
mvn clean install
```
